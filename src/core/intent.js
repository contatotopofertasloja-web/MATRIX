// src/core/intent.js
// Intenções canônicas: greet | qualify | offer | objection | close | postsale | delivery | payment | features | jump | confirm
// Implementação neutra, independente de produto/persona.
...
const RX = {
  // Pós-venda / pagamento confirmado
  ...
  // Logística / pagamento / especificações
  ...
  features: /\b(como\s*usar|aplicar|aplica[cç][aã]o|modo\s*de\s*uso|passo\s*a\s*passo|ingrediente|composi[cç][aã]o|ml|frasco|tamanho|garantia)\b/i,
