...
// ---------------------------------------------------------------------------
// Adapter Baileys com áudio end-to-end: getAudioBuffer (download de áudio)
// e sendAudio/sendVoice (envio PTT). Assinaturas compatíveis com o core.
// ---------------------------------------------------------------------------
...
export const adapter = {
  ...
  async sendMessage(to, payload) {
    ...
    return sock.sendMessage(jid, isObj ? { ...payload } : { text });
  },
      ...
      try {
        ...
        if (typeof _onMessageHandler === 'function') {
          ...
          if (typeof maybe === 'string' && maybe.trim()) {
            await adapter.sendMessage(from, { text: maybe });
          }
        }
      } catch (e) {
