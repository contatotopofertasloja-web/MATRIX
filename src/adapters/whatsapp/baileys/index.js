...
// 🔹 Alias compatível com o que o seu src/index.js importa
export const forceNewQr = forceRefreshQr;
...
// inclui os novos exports no default também
export default { init, stop, isReady, getQrDataURL, adapter, forceRefreshQr, forceNewQr, logoutAndReset };
